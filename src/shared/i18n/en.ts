...
export const en: Catalog = {
  ...
  analytics: {
    ...
    streakNote: "Consecutive days you stayed under your {target} daily target.",
  ...
  paywall: {
    ...
    benefit2: "Category breakdown & past-month reports",
    benefit3: "Scheduled auto-posting expenses",
    benefit4: "Unlimited fixed expenses + CSV export",
    benefit5: "All future Pro features",
    lifetime: "Lifetime",
    lifetimeNote: "one-time payment",
    annual: "Annual",
    annualNote: "renews yearly",
    bestValue: "Best value",
    launchNote: "Launch price — it'll rise as the app grows.",
