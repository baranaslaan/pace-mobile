...
export const tr = {
  ...
  subs: {
    ...
    freeLimit: "Ücretsiz planda en fazla {n} sabit gider.",
    freeLimitTail: " ile sınırsız ekle — tek seferlik, ömür boyu.",
  ...
  paywall: {
    ...
    benefit1: "Ay sonu bütçe öngörüsü",
    benefit2: "Geçmiş harcama dökümü",
    benefit3: "Tempo analizi ve trendler",
    benefit4: "Gelecekteki tüm Pro özellikleri",
